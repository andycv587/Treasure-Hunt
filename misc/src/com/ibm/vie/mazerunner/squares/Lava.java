...
/**
 * A square full of lava is difficult to traverse. Lava costs 61 steps to navigate.
 */
public class Lava extends Space {

  /**
   * Students will not create lava. Ignore this.
   * 
   * @param row The row index the square will be located at
   * @param col The column index the square will be located at
   */
  public Lava(int row, int col) {
    super(row, col);
  }
   ...
   * Students will not create lava. Ignore this.
   * 
   * @param other The Lava to clone from
   */
  public Lava(Lava other) {
    super(other);
  }
